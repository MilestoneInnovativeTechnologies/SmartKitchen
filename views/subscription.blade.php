...
$code = \Milestone\SmartKitchen\Controllers\SubscriptionController::code();
$array = ($code && stripos($code,"/")) ? json_decode(base64_decode(explode("/",$code)[1]),true) : [];
@endphp
<div style="display: flex; flex-direction: column; justify-content: center; align-items: center; height: 100vh">
    <div style="width: 360px; max-width: 90vw; background-color: #FEFEFE; padding: 40px 10px; text-align: center; border-radius: 25px; border: 5px double #CCCCCC">
    ...
    <div style="width: 360px; max-width: 90vw; margin-top: 10px;">
        <form method="post">
            ...
            @endif
            <input type="submit" name="login" value="Go to Login" style="padding: 5px 40px; border-radius: 5px; float: right" />

...
class CreateSettingsTable extends Migration
{
    ...
    public function up()
    {
        ...
        \Milestone\SmartKitchen\Models\Settings::create(['name' => 'kot_print_template', 'value' => '[["[id]","size3|center"],["Type:[type]|Time:[time_human]","around"],["Waiter:[user.name]|Seat:[seating.name]","around"],["","feed"],["items#Details:[quantity]x [item.name]|Narration:[narration]", "table"],["Quantity: [total_quantities]|Items: [total_items]","around"]]']);
        \Milestone\SmartKitchen\Models\Settings::create(['name' => 'kot_print_separate', 'value' => 'no']);
        \Milestone\SmartKitchen\Models\Settings::create(['name' => 'kot_add_print_template', 'value' => '[["[id]","size3|center"],["[item_state]","size3|center"],["Waiter:[user.name]|Seat:[seating.name]","around"],["","feed"],["[item_state] Item","center|underline|emphasis"],["Item: [item.name]"],["Quantity: [item.quantity]"],["Narration: [item.narration]"]]']);
        \Milestone\SmartKitchen\Models\Settings::create(['name' => 'kot_modify_print_template', 'value' => '[["[id]","size3|center"],["[item_state]","size3|center"],["Waiter:[user.name]|Seat:[seating.name]","around"],["","feed"],["[item_state] Item","center|underline|emphasis"],["Item: [item.name]"],["Quantity: [item.quantity]"],["Narration: [item.narration]"]]']);
        \Milestone\SmartKitchen\Models\Settings::create(['name' => 'kot_cancel_print_template', 'value' => '[["[id]","size3|center"],["[item_state]","size3|center"],["Waiter:[user.name]|Seat:[seating.name]","around"],["","feed"],["[item_state] Item","center|underline|emphasis"],["Item: [item.name]"],["Quantity: [item.quantity]"],["Narration: [item.narration]"]]']);

...
<!--        <q-item-section side><q-badge :label="token.progress" class="q-py-xs q-px-sm" :color="color" outline /></q-item-section>-->
    ...
    <q-dialog persistent v-model="show"><ArchiveTokenDetail v-if="Token" :token="Token" style="min-width: 80vw" :color="color" print_label="Print KOT" @print="print(Token)" @cancelled="show = false" /></q-dialog>

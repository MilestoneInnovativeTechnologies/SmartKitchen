<template>
  <q-page padding>
    ...
    <transition-group appear enter-active-class="animated zoomIn" leave-active-class="animated zoomOut">
      ...
      <q-page-sticky :key="'ktp-aoo-b'" position="bottom-right" :offset="[18, 18]" v-show="!offline_order" v-if="cloud"><q-btn fab icon="undo" color="secondary" padding="sm" class="flip-horizontal" @click="offline_order = true" /></q-page-sticky>
    </transition-group>

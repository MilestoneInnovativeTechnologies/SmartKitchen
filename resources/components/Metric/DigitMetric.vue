<template>
  <q-card class="no-shadow">
    <q-card-section :class="section_class">
      <div class="text-h4" style="font-weight: bolder">{{ value }}<q-icon class="q-mr-md q-mt-md absolute-right" v-if="icon" :color="icon_color" :name="icon" size="3.8rem"></q-icon></div>

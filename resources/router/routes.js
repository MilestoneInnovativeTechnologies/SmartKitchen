...
const layout_child = {
  Login: [
    'login_index',
    'display_kitchen_processing_tokens','display_active_tokens','display_pay_bill_qr_code'
  ],
...
const route_master = {
  ...
  delivery_boy_completed: { name:'delivery_boy_completed', path:'/completed', component: () => import('pages/DeliveryBoy/DeliveryBoyCompleted'), meta:{ title:'Billable Tokens' } },
  delivery_boy_billed: { name:'delivery_boy_billed', path:'/billed', component: () => import('pages/DeliveryBoy/DeliveryBoyBilled'), meta:{ title:'Deliverable Orders' } },
  ...
  display_kitchen_processing_tokens: { name:'display_kitchen_processing_tokens', path:'/kitchen/tokens', component: () => import('pages/Display/KitchenProcessingTokens'), meta:{ out_ping:true,color:'teal-14' } },
